...
export default function Dispositivos() {
    ...
    //         if(auth?.funcionalidade != 'atuador'){
    //             return {token: auth!.token, funcionalidade: 'atuador'} 
    //         }
    //     }
    ...
    const { data: dataDado, isLoading, isFetching, error, refetch,isSuccess } = useDado(localizacao, nomeDispositivo, tipoDispositivo, auth);
