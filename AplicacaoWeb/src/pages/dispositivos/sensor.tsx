...
export default function Dispositivos() {
    ...
    // //useEffect(() => {
    //     setAuth(construirAuth())
    //  // }, []);

    //   function construirAuth(){
    //     if((typeof auth !== 'undefined')){
    //         if(auth?.funcionalidade != 'sensor'){
    //             console.log("Executei")
    //             return {token: auth!.token, funcionalidade: 'sensor'} 
    //         }
    //     }
    ...
    const { data, isLoading, isFetching, error, refetch, isSuccess } = useDados(localizacao, nomeDispositivo, date ? date : null, tipoDispositivo, auth);
    ...
    useEffect(() => {
      // atualiza a variável de referência após a primeira renderização
    ...
    //         console.log('dataSessao sensor: '+ dataSessaoLocal.auth.funcionalidade)
